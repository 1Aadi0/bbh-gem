...
# --------------------------- Main --------------------------- #
def main(data_path: str = DATA_FILE, out_png: str = "Inspiral_Fields_Toroidal_Clean.png"):
    ...
    ax = axes[0, 0]
    # REMOVED: Lapse Heatmap (vals_alp) due to resolution artifact
    ...
    ax.set_aspect("equal")
    # No colorbar needed as no scalar field is plotted

    # --- PLOT 2: Electric Field (Streamlines Only) ---
    ax = axes[0, 1]
    # REMOVED: q0 Heatmap due to vacuum approximation inaccuracy
    ax.streamplot(vals_x, vals_y, vals_Ex, vals_Ey, color="white", density=1.2, arrowsize=1.0)
